...
# # Uncomment and properly set up dagshub integration
# import dagshub
# # Set environment variables for authentication
# os.environ['MLFLOW_TRACKING_USERNAME'] = 'f330018b6caa3e8f1b890d09fbc2097461a70429'  # Replace with your actual username

# # Initialize dagshub with your repo info
# dagshub.init(repo_owner='PSeshpavan', repo_name='DS_Project-1', mlflow=True)
...
#             # mlflow.set_registry_uri("https://dagshub.com/PSeshpavan/DS_Project-1.mlflow")
...
#                     X_test,  # Input example
#                     predicted_qualities  # Output example
#                     )
...
#                         signature=signature,
#                         input_example=X_test[:5]  # Using first 5 samples as example
#                     )
#                 else:
#                     mlflow.sklearn.log_model(
#                         best_model, 
